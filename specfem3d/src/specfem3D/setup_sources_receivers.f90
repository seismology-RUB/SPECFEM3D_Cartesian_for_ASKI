...
! filter source time function by Gaussian with hdur = HDUR_MOVIE when outputing movies or shakemaps
  ...
  if (USE_RICKER_TIME_FUNCTION) then !! FS FS : removed "USE_FORCE_POINT_SOURCE .or." from if-clause (this change was committed to devel branch by D.Komatitsch on 3 Sep 2015)
