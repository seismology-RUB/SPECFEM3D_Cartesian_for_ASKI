...
el = 10.0 # for first ASKI iteration, use element size 10.0 in order to have a good coverage of wavefield points. IN DISSERTATION, AND GJI ASKI PAPER, WE USED ELEMENT SIZE OF 7.0 -> UNDERESTIMATION!
